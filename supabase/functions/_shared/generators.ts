...
export const GENERATORS: Record<AssetType, GenSpec> = {
  ...
  brand_voice: {
    ...
    build: (c, p) => `${ctxBlock(c, p)}\n\nDefine a COMPLETE Brand Voice. Return STRICT JSON ONLY (no markdown, no code fences, no preamble). Fill every field with real, specific, on-brand copy — no placeholders. Shape:\n{\n  "overview": "<2-3 sentence overview of the voice>",\n  "pillars": [\n    { "name": "<pillar>", "description": "<2-3 sentences>", "why_it_fits": "<1-2 sentences>", "example": "<one real example sentence in the brand's voice>" }\n  ],\n  "tone_by_context": [\n    { "context": "Landing page",   "guidance": "<2-3 sentences>" },\n    { "context": "Product UI",     "guidance": "<2-3 sentences>" },\n    { "context": "Social",         "guidance": "<2-3 sentences>" },\n    { "context": "Support",        "guidance": "<2-3 sentences>" },\n    { "context": "Sales",          "guidance": "<2-3 sentences>" }\n  ],\n  "do":   [ { "phrase": "<short phrase or sentence pattern>", "why": "<1-line why>" } ],\n  "dont": [ { "phrase": "<short phrase or sentence pattern>", "why": "<1-line why>" } ],\n  "website_examples": [ { "label": "Hero",    "copy": "<real on-brand copy>" }, { "label": "Feature", "copy": "..." }, { "label": "CTA", "copy": "..." } ],\n  "social_examples":  [ { "platform": "X",        "copy": "..." }, { "platform": "LinkedIn", "copy": "..." }, { "platform": "X", "copy": "..." } ],\n  "launch_examples":  [ { "label": "Short",   "copy": "..." }, { "label": "Medium",  "copy": "..." } ],\n  "email_examples":   [ { "subject": "...",  "body": "..." }, { "subject": "...", "body": "..." } ]\n}\nGive exactly 4 pillars, 8 dos, 8 don'ts. Use the real product name from the context above.`,
  },
  brand_guidelines: {
