-- Chats: each /create submission is a chat that groups generated assets.
...
CREATE INDEX IF NOT EXISTS chats_user_idx ON public.chats(user_id, pinned DESC, updated_at DESC);
