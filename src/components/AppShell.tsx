          ...
          <nav className="ml-8 hidden items-center gap-2 text-sm font-medium text-neutral-700 md:flex">
            {isEditorPage ? headerActions : (
              <>
                ...
                <NavLink data-tour="nav-brand" to="/files" className={({ isActive }) => `rounded-lg px-3 py-2.5 transition ${isActive ? "text-neutral-900" : "hover:bg-neutral-100"}`}>Brand</NavLink>
