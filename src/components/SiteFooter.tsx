  ...
  <footer className="border-t border-neutral-200/60 bg-neutral-50">
    <div className="mx-auto max-w-6xl px-6 py-16">
      <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
        ...
        <div>
          <div className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Support</div>
          <ul className="mt-4 space-y-2.5 text-sm text-neutral-700">
        ...
        <div>
          <div className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Resources</div>
          <ul className="mt-4 space-y-2.5 text-sm text-neutral-700">
        ...
        <div>
          <div className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Connect</div>
          <ul className="mt-4 space-y-2.5 text-sm text-neutral-700">
      ...
      <div className="mt-12 border-t border-neutral-200 pt-6 text-center text-xs text-neutral-500">
        Copyright © 2026 Works App, Inc. Built with 🫶🏻 by <a href="https://works.xyz" target="_blank" rel="noreferrer" className="hover:text-neutral-900 underline">Works</a>.
      </div>
    </div>
  </footer>
);
