    ...
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-neutral-200 bg-white p-5">
          <div className="text-xs font-medium uppercase tracking-wider text-neutral-500">Brands</div>
        ...
        <div className="mt-4 overflow-hidden rounded-2xl border border-neutral-200 bg-white">
          {rockets.length === 0 ? (
            <div className="p-10 text-center">
              <p className="text-sm text-neutral-500">No Brands yet.</p>
              <Link to="/create" className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-brand px-4 py-2 text-sm text-brand-foreground hover:bg-brand-hover">Generate your first Brand <ArrowRight className="h-3.5 w-3.5" /></Link>
            </div>
          ) : (
