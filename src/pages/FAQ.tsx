...
const FAQS = [
  ...
  { q: "How does the Brand Kit work?", a: "Every Brand Kit holds one canonical item per category — logo, colours, typography, design system, and more. Swap or remove any item; Remove sends it to Trash and you can restore within 30 days. Add extras from any saved design via 'Use in brand kit'. Starter can view and share Brand Kits; downloading the full Brand Kit ZIP (logo variants, palette, fonts, Brand Book) is a Pro feature." },
  ...
  { q: "What's included in Pro?", a: "3,000 credits/month, Brand Kit ZIP downloads, workspaces & multi-seat, password-protected share links, brand guideline exports, and priority AI capacity. 7 days free, cancel anytime." },
